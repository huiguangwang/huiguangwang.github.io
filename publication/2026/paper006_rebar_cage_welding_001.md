<div class="paper-patent-item" style="display: flex; align-items: flex-start; margin: 20px 0; gap: 20px; flex-wrap: wrap;">
  <div style="position: relative; flex-shrink: 0; width: 100%; max-width: 300px; margin: 0 auto;">
    <img src="/web_resources\publication\picture\under_review.png" style="width: 100%; height: auto; display: block;">
  ...
  <div style="margin-top:6px;">
    <span class="keyword" style="background:rgba(231,76,60,0.2)"><strong>Rebar welding</strong></span>
    <span class="keyword" style="background:rgba(52,152,219,0.2)"><strong>Complex joint</strong></span>
    <span class="keyword" style="background:rgba(46,204,113,0.2)"><strong>Point cloud automatic annotation</strong></span>
  </div>
