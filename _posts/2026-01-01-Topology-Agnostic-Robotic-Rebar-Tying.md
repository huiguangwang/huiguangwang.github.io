...
<div style="text-align: center;">
  <p style="font-size: 30px; font-weight: bold; margin-bottom: 5px;">
    Geometry-Structured Perception for Topology-Agnostic Robotic Rebar Tying<br/>
  </p>
...
<div style="text-align: justify;">
  ...
  <p><strong>Keywords:</strong> Rebar tying automation; Geometry-structure-aware; Sim-to-real; Data-efficient; Robotic perception
  </p>
</div>