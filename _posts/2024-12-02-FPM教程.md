...
<div style="text-align: center;">
  <p><strong><font size='5'>Automated Point Positioning for Robotic Spot Welding Based on the Integration of 2D Drawings and Structured Light Cameras</font></strong><br/>
...
<div style="display: flex; align-items: center; margin-top: 20px; margin-bottom: 20px;">
  ...
  <div style="text-align: justify;">
    ...
    <p>
      ...
      <strong><font color='red'>This conference paper can also referred the tutorial above!</font></strong>
    </p>
  </div>
</div>
