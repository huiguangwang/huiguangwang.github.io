...
<div style="display: flex; align-items: center; margin-top: 20px; margin-bottom: 20px;">
  ...
  <div style="text-align: justify;">
    <span style="display: block; margin-bottom: 10px;">
      <b><a href="https://youtu.be/bmOHf3UX_T8" style="color: #1772d0;">Automated welding of complex stirrup joints in reinforcement cages for prefabricated concrete shear walls</a></b>
    </span>
    <p>
      <a href="https://www.youtube.com/watch?v=bmOHf3UX_T8" style="color: inherit; text-decoration: none;">The Complex Joints Welding of Rebar Cage
      </a>
      <br/>
    </p>
  </div>
