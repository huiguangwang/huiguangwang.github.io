...
<div style="display: flex; align-items: flex-start; margin-top: 20px; margin-bottom: 20px;">
  <div style="position: relative; flex-shrink: 0; width: 300px; margin-right: 20px;">
    <img src="/web_resources\publication\picture\unsupervisedLearning.png" style="width: 100%;">
    <span style="
      position: absolute;
      top: 10px;
      left: 10px;
  ...
  <div style="text-align: justify;">
    <span style="color:#1772d0; display: block; margin-bottom: 10px;">
      <b>An unified rebar tying and welding framework based on an unsupervised-learning segmentation(Under Review)</b>
    </span>
    <p>
      <strong>Huiguang Wang</strong>, Lu Deng, Shaopeng Xu, Yu Dai, Yi Shao<br>
